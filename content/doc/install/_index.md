...
There is number of ways you can change the configuration file in the container, for example by creating your own Docker file.
Another option is to create configuration file outside of the container in conf/ directory and mount this directory in the container.
...
3. Run container with the following addition command argument `-v ~/conf:/databunker/conf`.
