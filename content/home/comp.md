...
info1 = '"Select *" will return data in clear text even if you use database encryption. The data is encrypted only on disk. In case of SQL Injection the attacker will copy all your private data.'
